...
You will need to create your own fork, and commit within the fork your
own resluts in the appropriate benchmark directories. Results for each
benchmark are seperated by closed and open directories for the closed
and open divisions. Placehoder directories for various benchmarks are
include in these directories. YOu will need to place you benchmark in
te appropriate directory. Once committed to your fork, you can create
a pull request which will yhen be reviewed.

If you have issues with the submission or need help. Please contact the
mlcommons science workging group in the https://drive.google.com/drive/u/0/folders/19FK3PXa9DVIe9j7FawwihCb47F0V_nlC[Google group].
